...
description: Data platform for labeling, evaluating, and managing datasets that power production AI systems.
categories:
  - api-platform
  - data-analysis
use_cases:
...
self_hosted: false
features:
  - Managed data labeling for text, images, video, and sensor data
  - Evaluation tools for measuring model quality and safety
